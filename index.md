...
# Saad Tachrimant
**Senior Backend & Data Engineer (Freelance)**  
Java Spring Boot · Python · Data Engineering · Applied Machine Learning  
Remote (CET/GMT+1) · Part-time (Evenings & Weekends)

## What I do
I build and maintain production-grade backend systems, data pipelines, and applied ML features — with a focus on reliability, performance, and clear delivery.

- **Backend & APIs:** Spring Boot microservices, security (JWT), integrations, async processing
- **Data & Analytics:** preprocessing, time-series workflows, PostgreSQL/MongoDB, monitoring
- **Applied AI/ML:** forecasting (LSTM/GRU), anomaly detection, inference APIs, edge/IoT experimentation
